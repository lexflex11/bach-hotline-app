...
export const AESTHETICS = [
  ...
  {
    id:"mob_wives", name:"Mob Wives", emoji:"",
  ...
  {
    id:"mermaid_core", name:"Mermaid Core", emoji:"",
...
export const RAW_PRODUCTS = [
  ...
  { id:18, name:"Balloon Garland Kit",          fullName:"Balloon Garland Arch Kit, Bachelorette Party Decoration, DIY Balloon Arch",                        price:34.99, category:"Balloons",              tags:["balloon","garland","arch","kit"],      etsy:"", url:"", bestseller:true,  isDigital:false, rating:4.9, reviews:42 },
  { id:19, name:"Balloon Bouquet Set",          fullName:"Bachelorette Balloon Bouquet, 12-Piece Set, Pink & Gold Party Decor",                              price:16.99, category:"Balloons",              tags:["balloon","bouquet","pink","gold"],     etsy:"", url:"", bestseller:false, isDigital:false, rating:4.7, reviews:19 },
  //  Plates 
  { id:20, name:"Fire Flames Checker Plates",   fullName:"Fire Flames Checkered Party Plates, Bachelorette Tableware, Set of 8",                             price:10.12, category:"Plates",                tags:["plates","fire","checker","tableware"], etsy:"", url:"", bestseller:true,  isDigital:false, rating:4.8, reviews:27 },
  { id:21, name:"Hot Wheels Party Plates",      fullName:"Hot Wheels Theme Party Plates, Bachelorette Tableware, Set of 8",                                  price:10.12, category:"Plates",                tags:["plates","hot wheels","tableware"],     etsy:"", url:"", bestseller:false, isDigital:false, rating:4.7, reviews:14 },
  { id:22, name:"Pink Checker Plates",          fullName:"Pink Checkered Party Plates, Bachelorette Tableware, Set of 8",                                    price:9.99,  category:"Plates",                tags:["plates","pink","checker","party"],     etsy:"", url:"", bestseller:false, isDigital:false, rating:4.6, reviews:9  },
  //  Cutlery 
  { id:23, name:"Gold Cutlery Set",             fullName:"Gold Plastic Cutlery Set, Bachelorette Party Tableware, 24-Piece Set",                             price:19.85, category:"Cutlery",               tags:["cutlery","gold","plastic","tableware"],etsy:"", url:"", bestseller:true,  isDigital:false, rating:4.9, reviews:38 },
  { id:24, name:"Blue Cutlery Set",             fullName:"Blue Plastic Cutlery Set, Bachelorette Party Tableware, 24-Piece Set",                             price:14.99, category:"Cutlery",               tags:["cutlery","blue","plastic","tableware"],etsy:"", url:"", bestseller:false, isDigital:false, rating:4.7, reviews:11 },
  { id:25, name:"Pink Glitter Cutlery",         fullName:"Pink Glitter Cutlery Set, Bachelorette Party Tableware, 24-Piece",                                 price:16.50, category:"Cutlery",               tags:["cutlery","pink","glitter","party"],    etsy:"", url:"", bestseller:false, isDigital:false, rating:4.6, reviews:7  },
  //  Napkins 
  { id:26, name:"Hot Wheels Napkins",           fullName:"Hot Wheels Theme Party Napkins, Bachelorette, Pack of 20",                                         price:8.50,  category:"Napkins",               tags:["napkins","hot wheels","tableware"],    etsy:"", url:"", bestseller:true,  isDigital:false, rating:4.8, reviews:22 },
  { id:27, name:"Pink Checker Napkins",         fullName:"Pink Checkered Cocktail Napkins, Bachelorette Party, Pack of 20",                                  price:7.99,  category:"Napkins",               tags:["napkins","pink","checker","party"],    etsy:"", url:"", bestseller:false, isDigital:false, rating:4.7, reviews:13 },
  { id:28, name:"Gold Foil Napkins",            fullName:"Gold Foil Cocktail Napkins, Bachelorette Party Tableware, Pack of 20",                             price:8.25,  category:"Napkins",               tags:["napkins","gold","foil","tableware"],   etsy:"", url:"", bestseller:false, isDigital:false, rating:4.5, reviews:8  },
  //  Cups 
  ...
  { id:29, name:"Bach Babe Tumbler",            fullName:"Bach Babe Insulated Tumbler, Bachelorette Party Cup, 20 oz",                                       price:18.99, category:"Cups",                  tags:["tumbler","bach babe","insulated"],     etsy:"", url:"", bestseller:true,  isDigital:false, rating:4.9, reviews:33 },
  { id:30, name:"Bride Tribe Wine Cup",         fullName:"Bride Tribe Stemless Wine Cup, Bachelorette Party Favor, Set of 4",                                price:24.99, category:"Cups",                  tags:["wine cup","bride tribe","stemless"],   etsy:"", url:"", bestseller:false, isDigital:false, rating:4.8, reviews:17 },
  //  Confetti 
  { id:31, name:"Pink & Gold Confetti",         fullName:"Pink and Gold Confetti Mix, Bachelorette Party Table Decoration, 1 oz Bag",                        price:5.99,  category:"Confetti",              tags:["confetti","pink","gold","table"],      etsy:"", url:"", bestseller:true,  isDigital:false, rating:4.7, reviews:29 },
  { id:32, name:"Heart Confetti Mix",           fullName:"Heart-Shaped Confetti Mix, Bachelorette Party Decoration, 2 oz Bag",                              price:6.99,  category:"Confetti",              tags:["confetti","hearts","pink","decor"],    etsy:"", url:"", bestseller:false, isDigital:false, rating:4.6, reviews:16 },
  { id:33, name:"Star Confetti Cannons",        fullName:"Star Confetti Cannons, Bachelorette Party Pop, Set of 6",                                          price:12.99, category:"Confetti",              tags:["confetti","cannons","stars","party"],  etsy:"", url:"", bestseller:false, isDigital:false, rating:4.8, reviews:21 },
  //  Banners & Backdrops 
  { id:34, name:"Star Foil Fringe Banner",      fullName:"Star Foil Fringe Curtain Banner, Bachelorette Backdrop, 3.3 × 6.6 ft",                            price:55.00, category:"Banners & Backdrops",   tags:["banner","star","foil","backdrop"],     etsy:"", url:"", bestseller:true,  isDigital:false, rating:4.9, reviews:47 },
  { id:35, name:"Foil Fringe Curtain",          fullName:"Metallic Foil Fringe Curtain Backdrop, Bachelorette Party Decoration, Gold/Pink",                 price:12.99, category:"Banners & Backdrops",   tags:["curtain","fringe","foil","backdrop"],  etsy:"", url:"", bestseller:false, isDigital:false, rating:4.7, reviews:24 },
  { id:36, name:"Bride Banner",                 fullName:"Bride Script Letter Banner, Bachelorette Party Decoration, Rose Gold",                            price:9.99,  category:"Banners & Backdrops",   tags:["banner","bride","script","rose gold"], etsy:"", url:"", bestseller:false, isDigital:false, rating:4.6, reviews:12 },
  //  Treat Bags & Boxes 
  { id:9,  name:"Bach Weekend Survival Kit",    fullName:"Bach Weekend Bachelorette Kit, Survival Mini Tote, Party Favors",                                  price:28.25, category:"Treat Bags & Boxes",    tags:["survival kit","tote","favors"],        etsy:"https://i.etsystatic.com/40669879/r/il/be331c/7753024464/il_340x270.7753024464_9auc.jpg",  url:"https://www.etsy.com/listing/4464005263", bestseller:true,  isDigital:false, rating:4.9, reviews:31 },
  { id:10, name:"Let's Go Girls Bach Kit",      fullName:"Let's Go Girls Bachelorette Kit, Survival Mini Tote, Party Favors",                                price:28.25, category:"Treat Bags & Boxes",    tags:["lets go girls","tote","favor"],        etsy:"https://i.etsystatic.com/40669879/r/il/9594cb/7752997746/il_340x270.7752997746_25sx.jpg",  url:"https://www.etsy.com/listing/4464002387", bestseller:false, isDigital:false, rating:4.8, reviews:14 },
  { id:12, name:"In My Bride Era Bach Kit",     fullName:"In My Bride Era Bachelorette Kit, Survival Mini Tote, Party Favors",                               price:28.25, category:"Treat Bags & Boxes",    tags:["bride era","tote","trending"],         etsy:"https://i.etsystatic.com/40669879/r/il/b43b55/7750954064/il_340x270.7750954064_fc2p.jpg",  url:"https://www.etsy.com/listing/4463704232", bestseller:true,  isDigital:false, rating:5.0, reviews:28 },
  { id:37, name:"Bridal Goodie Bags",           fullName:"Bachelorette Goodie Bags, Set of 10, Pink & Gold Party Favor Bags",                               price:11.99, category:"Treat Bags & Boxes",    tags:["goodie bags","party favor","pink"],    etsy:"", url:"", bestseller:false, isDigital:false, rating:4.7, reviews:18 },
  //  Extras (show under All only) 
...
const PRODUCT_DETAILS_NEW = {
  18: { desc:"Everything you need for a stunning balloon garland arch. Easy DIY setup with no special tools required.", bullets:["130 assorted balloons (5\", 12\", 18\", 24\")", "Balloon strip tape and glue dots included", "Sets up in about 30 minutes", "Great for photo backdrop or table display"] },
  19: { desc:"A ready-to-go balloon bouquet that adds instant party vibes to any space.", bullets:["12 assorted latex balloons", "Pink, white, and gold color mix", "Comes with curling ribbon", "Air-fill or helium compatible"] },
  20: { desc:"Edgy, trendy, and totally bachelorette-approved. These fire and flames checkered plates are the move for a bold table setup.", bullets:["Set of 8 sturdy paper plates", "10-inch diameter", "Grease-resistant coating", "Disposable and eco-conscious material"] },
  21: { desc:"Rev up the party with these Hot Wheels themed plates that bring maximum energy to the bach weekend table.", bullets:["Set of 8 paper plates", "10-inch diameter", "Premium print quality", "Pairs perfectly with matching napkins"] },
  22: { desc:"Classic pink checkerboard plates that match every aesthetic — from retro to modern glam.", bullets:["Set of 8 paper plates", "10-inch diameter", "Bold pink checker print", "Pairs with Pink Checker Napkins"] },
  23: { desc:"Elevate your tablescape with these chic gold plastic cutlery sets. Looks expensive, totally isn't.", bullets:["24-piece set (8 forks, 8 knives, 8 spoons)", "Shiny gold metallic finish", "Heavy-duty plastic, reusable", "Dishwasher safe"] },
  24: { desc:"Cool, crisp blue cutlery that gives any table a fresh, vibrant look without spending a fortune.", bullets:["24-piece set (8 forks, 8 knives, 8 spoons)", "Bold blue metallic finish", "Heavy-duty plastic, reusable", "Dishwasher safe"] },
  25: { desc:"Make your table sparkle with these glamorous pink glitter cutlery pieces that photograph beautifully.", bullets:["24-piece set", "Pink glitter metallic finish", "Heavy-duty plastic", "Perfect for photo-worthy table setups"] },
  26: { desc:"Match your plates! These Hot Wheels themed napkins complete the boldest bachelorette table setup.", bullets:["Pack of 20 cocktail napkins", "3-ply absorbent paper", "Matching Hot Wheels print", "5\" × 5\" folded size"] },
  27: { desc:"The pink checker napkin that goes with literally everything. Stock up — you'll use them all.", bullets:["Pack of 20 cocktail napkins", "3-ply paper, super absorbent", "Folds neatly on a table", "Pairs with Pink Checker Plates"] },
  28: { desc:"Elevate the table with these luxe gold foil cocktail napkins. Simple, chic, and effortlessly elevated.", bullets:["Pack of 20 napkins", "Embossed gold foil detail", "3-ply soft paper", "Great for open bar or cocktail hour"] },
  29: { desc:"Keep the squad's drinks cold and the vibes hot. This insulated Bach Babe tumbler is the must-have accessory for the bach weekend.", bullets:["20 oz double-wall insulated", "Keeps drinks cold up to 12 hours", "Leak-proof lid included", "Makes a perfect bridesmaid gift"] },
  30: { desc:"A set of four stemless wine cups for the whole Bride Tribe to sip in style. Cheers to the bride!", bullets:["Set of 4 stemless wine cups", "12 oz capacity each", "BPA-free acrylic", "Dishwasher safe top rack"] },
  31: { desc:"Scatter it everywhere — tables, floors, toss it during toasts. This pink and gold confetti mix is pure party perfection.", bullets:["1 oz bag (about 1,000 pieces)", "Mix of pink and gold foil", "Hearts and circle shapes", "Great for table scatter or photo booth"] },
  32: { desc:"Because every Bach weekend needs a confetti moment. These heart-shaped pieces are made for throwing.", bullets:["2 oz bag", "Pink and rose gold hearts", "Biodegradable paper option", "Table scatter or toss confetti"] },
  33: { desc:"Pop it, girl. These star confetti cannons go off with a bang and fill the air with shimmer.", bullets:["Set of 6 cannons", "Star-shaped gold and pink confetti", "Easy-pull trigger", "Perfect for a big reveal or toast moment"] },
  34: { desc:"The ultimate bachelorette backdrop — this star foil fringe banner is made to stop the scroll.", bullets:["3.3 × 6.6 ft coverage per panel", "Holographic star foil fringe", "Easy to hang with included tape", "Reusable for multiple events"] },
  35: { desc:"A shimmery metallic fringe curtain that instantly transforms any wall, doorway, or photo spot.", bullets:["8 ft × 3 ft panel", "Gold and pink metallic foil", "Easy to hang — includes adhesive strips", "Can be trimmed to any length"] },
  36: { desc:"Spell it out in rose gold. This script 'Bride' banner is cute, simple, and endlessly versatile.", bullets:["Pre-strung on twine", "Rose gold metallic finish", "About 5 ft long when hung", "Reusable"] },
  37: { desc:"Send everyone home with something cute. These goodie bags are already pre-sized and ready to fill with your fave party favors.", bullets:["Set of 10 bags", "Pink and gold design", "Holds standard party favors", "Flat bottom stands upright"] },
};

const PRODUCT_DETAILS = {
  1:  { desc:"Turn heads and light up every room with this glam disco ball headband. Perfect for bachelorette parties, girls nights, and any celebration that deserves a little sparkle.", bullets:["Sparkling mirror disco ball clusters","Fits most head sizes comfortably","Perfect photo booth accessory","Great as a party favor or gift"] },
  2:  { desc:"A stunning 40-inch floral number balloon that makes any space look instantly party-ready. Beautiful garden print with bold, eye-catching color.", bullets:["40 inches tall when inflated","Self-sealing valve — easy to fill","Floats with helium or can be air-filled","Suitable for indoor and outdoor use"] },
  3:  { desc:"Wild, bold, and totally on-trend — this zebra print number balloon is a statement piece for any bachelorette or birthday setup.", bullets:["40 inches tall when inflated","Zebra print foil finish","Works with helium or air pump","Reusable — deflates and re-inflates"] },
  4:  { desc:"Skip hours of planning. This professionally curated 3-day Corpus Christi bachelorette itinerary covers beaches, restaurants, nightlife, and more.", bullets:["Instant digital download (PDF)","3-day hour-by-hour schedule","Includes top restaurant & bar recs","Customizable in Canva (template included)"] },
  5:  { desc:"A fun and memorable bachelorette party favor your girls will actually keep. Customize with a photo or design that's totally you.", bullets:["Personalized with your photo or design","High-quality puzzle pieces","Comes in a keepsake box","Makes a thoughtful bridesmaid gift"] },
  6:  { desc:"Deal out the fun with custom poker playing cards! Great for game nights, pool days, or as a unique bachelorette party favor.", bullets:["Full standard deck (52 cards + 2 jokers)","Custom printed card backs","Premium card stock with smooth finish","Comes in a gift box"] },
  7:  { desc:"The ultimate girls trip accessory — a beach towel printed with a custom face design that'll have everyone laughing and obsessing.", bullets:["Ultra-soft, absorbent microfiber","Custom printed with your chosen photo","30\" × 60\" — full beach size","Machine washable, color-safe print"] },
  8:  { desc:"Wear it proud! This custom face bikini is the funniest, most iconic bachelorette party look for pool days and beach trips.", bullets:["Printed with a custom face or photo","Available in multiple sizes","80% polyester, 20% spandex","UPF 50+ sun protection"] },
  9:  { desc:"Everything she needs to survive (and thrive) the bach weekend. Packed with essentials in a cute mini tote she can keep forever.", bullets:["Curated survival essentials inside","Reusable mini tote bag","Custom bach weekend branding","Perfect bridesmaid or party favor gift"] },
  10: { desc:"Let's go girls! This kit is packed with fun essentials for the bride tribe. A must-have for the squad that shows up and shows out.", bullets:["Reusable mini tote with printed design","Party essentials included","Great for bridesmaids or guests","Ships ready to gift"] },
  11: { desc:"Giddy up! This novelty cowgirl espresso cup is the cutest way to get your morning caffeine fix on a Nashville or country-themed bach.", bullets:["Holds 3 oz (espresso size)","Novelty ceramic construction","Dishwasher safe","Makes a fun keepsake or party favor"] },
  12: { desc:"She's in her bride era and this kit knows it. Trendy, fun, and totally giftable — the perfect bachelorette survival kit for the modern bride.", bullets:["\"In My Bride Era\" branded tote","Party survival essentials included","Trending aesthetic design","Perfect bridesmaid gift"] },
  13: { desc:"A modern, artsy sardinas-print beach towel that's equal parts statement piece and beach essential. Perfect for the trendsetter in the group.", bullets:["Soft microfiber, quick-dry fabric","30\" × 60\" full beach size","Bold sardinas print design","Machine washable"] },
  14: { desc:"Sleek, chic, and totally fierce — this panther print beach towel is the girls trip accessory that says 'we did not come to play.'", bullets:["Premium microfiber fabric","Bold panther print","30\" × 60\" full size","Quick-dry and machine washable"] },
  15: { desc:"Welcome to the Cocktail Club. This towel is made for the girls who take their pool days as seriously as their drink orders.", bullets:["Soft and absorbent microfiber","Fun cocktail-themed print","30\" × 60\" full beach size","Machine washable, color-fast"] },
  16: { desc:"Retro vibes meet floral charm in this groovy beach towel. Bring the 70s energy to the beach, pool, or anywhere the girls are gathering.", bullets:["Groovy floral retro print","Super soft microfiber","30\" × 60\" — perfect beach size","Machine washable"] },
  17: { desc:"Fries before guys! This fast food printed beach towel is the quirkiest, most Instagrammable addition to any girls trip.", bullets:["Fun fast food graphic print","Premium microfiber fabric","30\" × 60\" full size","Machine washable, vibrant colors"] },
};
...
export const DESTS = [
  ...
  { id:"sandiego",    name:"San Diego",       emoji:"", vibe:"Beach & Craft Beer",     trend:"Chill Vibes",       airportCode:"SAN", toFull:"San Diego, CA"                        },
  { id:"palmsprings", name:"Palm Springs",    emoji:"", vibe:"Pool Glam & Desert",     trend:"Retro Cool",        airportCode:"PSP", toFull:"Palm Springs, CA"                     },
  ...
  { id:"denver",      name:"Denver / Aspen",  emoji:"", vibe:"Mountains & Brunch",     trend:"Year-Round",        airportCode:"DEN", toFull:"Denver, CO"                           },
  { id:"houston",        name:"Houston",          emoji:"", vibe:"BBQ, Nightlife & Culture",   trend:"Local Fave",    airportCode:"IAH", toFull:"Houston, TX"              },
  { id:"corpuschristi", name:"Corpus Christi",   emoji:"", vibe:"Beach & Bay City Vibes",     trend:"Hidden Gem",    airportCode:"CRP", toFull:"Corpus Christi, TX"       },
  ...
  { id:"cancun",      name:"Cancun / Tulum",  emoji:"", vibe:"All-Inclusive & Cenotes",trend:"Trending ",      airportCode:"CUN", toFull:"Cancun, Mexico",          international:true },
...
export const FLIGHTS = [
  ...
  { id:4, from:"NYC", to:"Scottsdale",  airline:"American",  date:"Jun 14", price:94,  seats:9,  tag:" Sun & Sip",   dest:"scottsdale", toFull:"Scottsdale, AZ"  },
