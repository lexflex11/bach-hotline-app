...
const EXP = [
  ...
  { id:9,  city:"nashville", name:"Hot Chicken Tasting Tour",    cat:"food",      emoji:"", price:"$$",  rating:4.8, vibe:"3 stops · Nashville staple",     badge:"Food Tour",  hot:false },
  ...
  // Cabo
  { id:32, city:"cabo",      name:"Private Yacht Party",         cat:"water",     emoji:"", price:"$$$$", rating:5.0, vibe:"Open bar · Snorkeling · Sunset", badge:"Yacht",      hot:true  },
  { id:33, city:"cabo",      name:"Medano Beach Club",           cat:"activity",  emoji:"", price:"$$$",  rating:4.8, vibe:"VIP beds · Bottle service",      badge:"Beach Club", hot:true  },
  { id:34, city:"cabo",      name:"ATV Desert Adventure",        cat:"activity",  emoji:"", price:"$$",   rating:4.7, vibe:"Desert dunes · 2 hrs",            badge:"Adventure",  hot:false },
  ...
  // Chicago
  { id:72, city:"chicago",     name:"Architecture Boat Tour",       cat:"water",     emoji:"", price:"$$",  rating:4.9, vibe:"River · Skyline · Architecture",   badge:"Cruise",     hot:true  },
  ...
  { id:85, city:"palmsprings", name:"Desert Jeep Adventure",        cat:"activity",  emoji:"", price:"$$",  rating:4.7, vibe:"Sand dunes · Sunset views · 2 hrs",badge:"Adventure",  hot:false },
  ...
  { id:103, city:"denver",     name:"Rocky Mountain Hike & Brunch", cat:"activity",  emoji:"", price:"$$",  rating:4.9, vibe:"Scenic trails · Brunch after",     badge:"Adventure",  hot:true  },
  ...
  { id:116, city:"corpuschristi", name:"Mustang Island Beach Day",      cat:"activity", emoji:"",price:"$",    rating:4.8, vibe:"Private beach setup · Chairs & umbrella",badge:"Beach",     hot:false },
  ...
  { id:311, city:"nyc",         name:"Great Jones Spa",                cat:"spa",   emoji:"", price:"$$$",  rating:4.9, vibe:"Water lounge · Waterfall · SoHo location",       badge:"Spa",      hot:true  },
  ...
  { id:466, city:"chicago",     name:"Architecture & Cocktail Cruise", cat:"bonus", emoji:"", price:"$$$",  rating:4.9, vibe:"Open bar · Skyline · Only-in-Chicago experience", badge:"Unique",   hot:true  },
  ...
  { id:474, city:"cabo",        name:"ATV Desert Adventure Tour",      cat:"bonus", emoji:"", price:"$$$",  rating:4.9, vibe:"Off-road · Desert · Canyon views · 3 hrs",        badge:"Adventure",hot:true  },
  ...
  { id:46, city:"nola",       name:"Garden District Mansion",     cat:"stay", emoji:"", price:"$$$", rating:4.9, vibe:"5BR · Private courtyard · Historic charm",      badge:"Mansion",  hot:true  },
  ...
  { id:53, city:"cabo",       name:"Medano Beach Penthouse",      cat:"stay", emoji:"", price:"$$$", rating:4.8, vibe:"Beachfront · Rooftop terrace · 3BR",            badge:"Penthouse",hot:false },
  { id:54, city:"mykonos",    name:"Cycladic Cliffside Villa",    cat:"stay", emoji:"", price:"$$$$",rating:5.0, vibe:"Infinity pool · Sea views · 4BR",               badge:"Villa",    hot:true  },
  ...
  { id:117, city:"nyc",         name:"Brooklyn Brownstone",          cat:"stay", emoji:"", price:"$$$", rating:4.8, vibe:"4BR · Rooftop deck · Hip neighborhood",          badge:"Airbnb",    hot:false },
  ...
  { id:120, city:"sandiego",    name:"Pacific Beach Oceanfront Home",cat:"stay", emoji:"", price:"$$$$",rating:5.0, vibe:"4BR · Private deck · Steps to beach",           badge:"Beach Home", hot:true  },
  ...
  { id:130, city:"denver",      name:"Capitol Hill Party House",     cat:"stay", emoji:"", price:"$$$", rating:4.9, vibe:"5BR · Hot tub · Mountain views from roof",       badge:"Airbnb",    hot:true  },
  ...
  //  Flights 
  { id:200, city:"miami",       name:"Flights to Miami",              cat:"flight", emoji:"", price:"$$",   rating:4.9, vibe:"MIA · Direct flights from most major US cities",  badge:"Flights", hot:true,  bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:MIA" },
  { id:201, city:"nashville",   name:"Flights to Nashville",          cat:"flight", emoji:"", price:"$$",   rating:4.9, vibe:"BNA · Southwest & Delta hub · Easy connections", badge:"Flights", hot:true,  bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:BNA" },
  { id:202, city:"vegas",       name:"Flights to Las Vegas",          cat:"flight", emoji:"", price:"$",    rating:4.9, vibe:"LAS · Best flight deals in the US",              badge:"Flights", hot:true,  bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:LAS" },
  { id:203, city:"nola",        name:"Flights to New Orleans",        cat:"flight", emoji:"", price:"$$",   rating:4.8, vibe:"MSY · Direct from most Southeast hubs",          badge:"Flights", hot:true,  bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:MSY" },
  { id:204, city:"scottsdale",  name:"Flights to Phoenix/Scottsdale", cat:"flight", emoji:"", price:"$$",   rating:4.8, vibe:"PHX · Southwest stronghold · Great deals",       badge:"Flights", hot:true,  bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:PHX" },
  { id:205, city:"austin",      name:"Flights to Austin",             cat:"flight", emoji:"", price:"$$",   rating:4.8, vibe:"AUS · Growing hub · Southwest, United, Delta",   badge:"Flights", hot:true,  bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:AUS" },
  { id:206, city:"charleston",  name:"Flights to Charleston",         cat:"flight", emoji:"", price:"$$",   rating:4.7, vibe:"CHS · American, Delta, Southwest",                badge:"Flights", hot:false, bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:CHS" },
  { id:207, city:"savannah",    name:"Flights to Savannah",           cat:"flight", emoji:"", price:"$$",   rating:4.7, vibe:"SAV · Delta hub · Easy Southern connections",    badge:"Flights", hot:false, bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:SAV" },
  { id:208, city:"nyc",         name:"Flights to New York City",      cat:"flight", emoji:"", price:"$$$",  rating:4.8, vibe:"JFK/LGA/EWR · All major airlines",               badge:"Flights", hot:true,  bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:JFK" },
  { id:209, city:"chicago",     name:"Flights to Chicago",            cat:"flight", emoji:"", price:"$$",   rating:4.8, vibe:"ORD/MDW · United hub · Great midwest prices",    badge:"Flights", hot:true,  bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:ORD" },
  { id:210, city:"sandiego",    name:"Flights to San Diego",          cat:"flight", emoji:"", price:"$$",   rating:4.8, vibe:"SAN · Southwest & Alaska stronghold",             badge:"Flights", hot:false, bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:SAN" },
  { id:211, city:"palmsprings", name:"Flights to Palm Springs",       cat:"flight", emoji:"", price:"$$",   rating:4.7, vibe:"PSP · Small airport · Direct from LA, SF, SEA",  badge:"Flights", hot:false, bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:PSP" },
  { id:212, city:"napa",        name:"Flights to Napa (SFO)",         cat:"flight", emoji:"", price:"$$$",  rating:4.7, vibe:"Fly into SFO · 1 hr drive to Wine Country",       badge:"Flights", hot:false, bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:SFO" },
  { id:213, city:"keywest",     name:"Flights to Key West",           cat:"flight", emoji:"", price:"$$$",  rating:4.7, vibe:"EYW · Small paradise airport · Direct from MIA", badge:"Flights", hot:false, bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:EYW" },
  { id:214, city:"sedona",      name:"Flights to Sedona (PHX)",       cat:"flight", emoji:"", price:"$$",   rating:4.7, vibe:"Fly into PHX · 2 hr scenic drive to Sedona",      badge:"Flights", hot:false, bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:PHX" },
  { id:215, city:"denver",      name:"Flights to Denver",             cat:"flight", emoji:"", price:"$$",   rating:4.8, vibe:"DEN · United hub · Mountain gateway airport",     badge:"Flights", hot:true,  bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:DEN" },
  { id:216, city:"houston",     name:"Flights to Houston",            cat:"flight", emoji:"", price:"$$",   rating:4.8, vibe:"IAH/HOU · United hub · Great Southern deals",    badge:"Flights", hot:true,  bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:IAH" },
  { id:217, city:"cabo",        name:"Flights to Cabo",               cat:"flight", emoji:"", price:"$$$",  rating:4.9, vibe:"SJD · Direct from most US cities · 3-5 hrs",     badge:"Flights", hot:true,  bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:SJD" },
  { id:218, city:"mykonos",     name:"Flights to Mykonos",            cat:"flight", emoji:"", price:"$$$$", rating:4.9, vibe:"JMK · Via Athens or direct from NYC",             badge:"Flights", hot:true,  bookingUrl:"https://www.expedia.com/Flights-Search?trip=roundtrip&leg1=from:USA,to:JMK" },
...
const ACT_OPTIONS = [
  ...
  { id:"food",      label:"Restaurants",   icon:"", cats:["food","restaurant"] },
