  ...
  return (
    <>
      ...
      {GARLAND_3D_LAYOUT.map((b, i) => (
        <Balloon3D
          key={i}
          position={[b[0]*0.72, b[1]*0.72, b[2]*0.72]}
          radius={b[3]}
...
const TABLEWARE = [
  ...
  },
  {
    ...
    image:"https://images.squarespace-cdn.com/content/v1/66c512fff5e80a05a6127fea/cd8ac1a1-9a8b-4129-86d1-d93a0fa17d8e/Ebook+Thumbnail+with+Video-411.png",
