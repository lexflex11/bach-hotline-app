...
// ── 3D Garland Preview ────────────────────────────────────────────────────────
// [x, y, z, radius, colorIndex]  — all x/y scaled 0.78x for tight overlap
const GARLAND_3D_LAYOUT = [
  // ── SPINE ────────────────────────────────────────────────────────────────
  [-2.50, -0.62,  0.00, 1.00, 0],
  [-1.17,  0.00,  0.10, 1.05, 1],
  [ 0.16,  0.55, -0.10, 1.05, 2],
  [ 1.48,  0.86,  0.10, 1.00, 3],
  [ 2.57,  0.70, -0.10, 0.90, 4],
  [ 3.43,  0.31,  0.10, 0.82, 0],

  // ── ABOVE SPINE ──────────────────────────────────────────────────────────
  [-1.87,  0.70,  0.20, 0.88, 2],
  [-0.55,  1.33, -0.20, 0.90, 3],
  [ 0.78,  1.48,  0.20, 0.88, 4],
  [ 2.11,  1.64, -0.20, 0.82, 0],
  [ 3.12,  1.33,  0.10, 0.72, 1],

  // ── BELOW SPINE ──────────────────────────────────────────────────────────
  [-3.04, -1.33,  0.20, 0.82, 3],
  [-1.87, -1.40, -0.20, 0.85, 4],
  [-0.62, -0.78,  0.20, 0.78, 0],
  [ 0.55, -0.31, -0.20, 0.73, 1],
  [ 1.79,  0.00,  0.10, 0.68, 2],

  // ── MEDIUM FRONT (z+) ────────────────────────────────────────────────────
  [-2.26,  0.08,  1.55, 0.55, 4],
  [-0.94,  0.70,  1.60, 0.55, 0],
  [ 0.31,  1.02,  1.55, 0.52, 1],
  [ 1.48,  1.17,  1.55, 0.50, 2],
  [-1.48, -0.62,  1.45, 0.52, 3],
  [ 0.00, -0.08,  1.60, 0.50, 4],
  [ 1.09,  0.08,  1.55, 0.48, 0],
  [ 2.42,  0.70,  1.45, 0.48, 1],

  // ── MEDIUM BACK (z-) ─────────────────────────────────────────────────────
  [-1.95,  0.39, -1.55, 0.53, 2],
  [-0.55,  0.94, -1.60, 0.52, 3],
  [ 0.94,  1.25, -1.55, 0.50, 4],
  [-1.09, -0.47, -1.45, 0.50, 0],
  [ 0.31,  0.16, -1.55, 0.48, 1],
  [ 2.03,  0.31, -1.35, 0.45, 2],

  // ── MEDIUM DEEP FRONT ────────────────────────────────────────────────────
  [-1.48,  0.23,  2.20, 0.45, 3],
  [ 0.16,  0.62,  2.10, 0.45, 4],
  [ 1.33,  0.78,  2.00, 0.42, 0],

  // ── SMALL BOTTOM EDGE ────────────────────────────────────────────────────
  [-3.66, -0.70,  0.10, 0.30, 1],
  [-3.12, -1.80,  0.00, 0.28, 2],
  [-2.42, -2.03,  0.10, 0.28, 3],
  [-1.56, -2.03,  0.00, 0.26, 4],
  [-0.78, -1.40,  0.10, 0.28, 0],
  [ 0.08, -1.09,  0.00, 0.26, 1],
  [ 1.02, -0.70,  0.10, 0.28, 2],
  [ 2.11, -0.47,  0.00, 0.26, 3],
  [ 2.96, -0.08,  0.10, 0.26, 4],
  [ 3.82,  0.08,  0.00, 0.26, 0],

  // ── SMALL TOP EDGE ───────────────────────────────────────────────────────
  [-2.96,  0.23,  0.00, 0.28, 1],
  [-2.42,  1.09,  0.10, 0.28, 2],
  [-1.40,  1.72,  0.00, 0.26, 3],
  [-0.47,  2.11,  0.10, 0.28, 4],
  [ 0.47,  2.26,  0.00, 0.26, 0],
  [ 1.48,  2.34,  0.10, 0.26, 1],
  [ 2.50,  2.19,  0.00, 0.26, 2],
  [ 3.35,  1.80,  0.10, 0.26, 3],
  [ 3.98,  0.94,  0.00, 0.26, 4],

  // ── SMALL DEPTH CLUSTERS ─────────────────────────────────────────────────
  [-2.65, -0.08,  2.00, 0.26, 0],
  [-0.70,  0.31,  2.20, 0.26, 1],
  [ 0.70,  0.47,  2.20, 0.26, 2],
  [ 2.11,  0.47,  1.90, 0.26, 3],
  [-1.48,  0.23, -2.00, 0.26, 4],
  [ 0.31,  0.78, -2.10, 0.26, 0],
  [ 1.64,  0.62, -1.80, 0.26, 1],

  // ── TINY GAP FILLERS ─────────────────────────────────────────────────────
  [-2.89,  0.00,  0.00, 0.15, 2],
  [-2.03, -0.39,  0.00, 0.15, 3],
  [-1.33, -0.31,  0.00, 0.15, 4],
  [-0.55,  0.23,  0.00, 0.15, 0],
  [ 0.31, -0.16,  0.00, 0.15, 1],
  [ 1.09,  0.31,  0.00, 0.15, 2],
  [ 1.95,  1.25,  0.00, 0.15, 3],
  [ 2.89,  1.09,  0.00, 0.15, 4],
  [-1.48,  1.87,  0.00, 0.15, 0],
  [-0.16,  2.34,  0.00, 0.15, 1],
  [ 1.09,  2.42,  0.00, 0.15, 2],
  [ 2.89, -0.39,  0.00, 0.15, 3],
  [-2.26, -1.80,  0.00, 0.15, 4],
  [-0.31, -1.02, -0.10, 0.15, 0],
  [ 0.70, -0.62,  0.10, 0.15, 1],
  [-3.43, -0.39,  0.00, 0.15, 2],
  [ 3.90,  0.62,  0.00, 0.15, 3],
];
...
const GARLAND_X_MIN = -3.8;
const GARLAND_X_MAX = 4.1;
  ...
  return (
    <div style={{borderRadius:14,overflow:"hidden",border:`1.5px solid ${BORDER}`,background:bg}}>
      <div style={{height:260,background:bg}}>
        <Canvas camera={{ position:[0.5, 3.0, 9.5], fov:55 }} style={{background:bg}}>
